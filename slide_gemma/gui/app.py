...
from .desktop_inference import DesktopInferenceThread
from .video_worker import VideoAnalysisWorker
from .i18n import LANGUAGE_OPTIONS, model_output_language, normalize_ui_language, tr
from .desktop_capture import CaptureSettings, CaptureThread
from .subtitle import SubtitleBar
from .windows import WindowDescriptor, is_window_alive, list_windows
...
class Launcher(QWidget):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("slideGemma")
    ...
    def _build_ui(self):
        ...
        self._title_label = QLabel("slideGemma")
    ...
    def _start_desktop_mode(self):
        ...
        if not target:
            QMessageBox.information(self, "slideGemma", self._text("choose_target_window_message"))
            return
    ...
    def _on_worker_error(self, message: str):
        ...
        QMessageBox.warning(self, "slideGemma", message)
